...
Board = (function ()
{
    ...
    {
        var h, key, _20_18_, _21_30_, _22_30_, _23_30_, _24_30_, _25_30_, _26_30_
        ...
        for (var _65_16_ = 0; _65_16_ < list.length; _65_16_++)
        {
            key = list[_65_16_]
    ...
    Board.prototype["lines"] = function ()
    {
        ...
        for (var _139_17_ = i = 0, _139_21_ = this.size; (_139_17_ <= _139_21_ ? i < this.size : i > this.size); (_139_17_ <= _139_21_ ? ++i : --i))
        {
            this.ctx.beginPath()
    ...
    Board.prototype["coordinates"] = function ()
    {
        ...
        d = 100 / (this.size + 1)
        for (var _169_17_ = x = 0, _169_21_ = this.size; (_169_17_ <= _169_21_ ? x < this.size : x > this.size); (_169_17_ <= _169_21_ ? ++x : --x))
        {
    ...
    {
        var _390_12_, _391_12_, _392_12_, _393_12_
    ...
    Board.prototype["variations"] = function ()
    {
        ...
        for (var _471_15_ = 0; _471_15_ < list.length; _471_15_++)
        {
            mv = list[_471_15_]
    ...
    Board.prototype["onVariation"] = function (variation)
    {
        ...
        for (var _489_14_ = 0; _489_14_ < list.length; _489_14_++)
        {
            m = list[_489_14_]
    ...
    Board.prototype["liberties"] = function ()
    {
        ...
        for (var _518_18_ = 0; _518_18_ < list.length; _518_18_++)
        {
            color = list[_518_18_]
            var list1 = _k_.list(this.game.allStones(color))
            for (var _519_19_ = 0; _519_19_ < list1.length; _519_19_++)
            {
                st = list1[_519_19_]
    ...
    Board.prototype["territory"] = function ()
    {
        ...
        if (this.game)
        {
            if (this.game.moves.num() > 1)
            {
                ...
                for (var _546_22_ = 0; _546_22_ < list.length; _546_22_++)
                {
                    a = list[_546_22_]
                    if (_k_.in(a.color,'wbWB'))
                    {
                        var list1 = _k_.list(a.posl)
                        for (var _548_30_ = 0; _548_30_ < list1.length; _548_30_++)
                        {
                            p = list1[_548_30_]
                ...
                for (var _553_22_ = 0; _553_22_ < list2.length; _553_22_++)
                {
                    g = list2[_553_22_]
                    if (g.state === 'dead')
                    {
                        var list3 = _k_.list(g.posl)
                        for (var _555_30_ = 0; _555_30_ < list3.length; _555_30_++)
                        {
                            p = list3[_555_30_]
