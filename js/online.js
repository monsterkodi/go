...
Online = (function ()
{
    ...
    Online.prototype["loadGame"] = function (g)
    {
        ...
        for (var _160_15_ = 0; _160_15_ < list.length; _160_15_++)
        {
            mv = list[_160_15_]
            this.referee.tree.addMove(mv.pos,((_161_54_=mv.captures) != null ? _161_54_ : []),mv.color)
        }
    }
